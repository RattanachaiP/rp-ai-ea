"""Canonical, domain-separated identities for PR184 artifacts."""

import json
from hashlib import sha256
from uuid import UUID, uuid5

RECORD_NAMESPACE = UUID("f1840001-0000-5000-8000-000000000001")
...
def intelligence_uuid(value): return _uuid(RECORD_NAMESPACE, value)
