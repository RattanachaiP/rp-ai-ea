        ...
        for eligibility in sorted(records, key=lambda item: item.selection_uuid):
            ...
            record = ConfidenceRecord.create(
                **partition,
                ...
                memory_version=eligibility.memory_version,
                memory_state=eligibility.memory_state,
                source_report_uuid=eligibility.source_report_uuid,
                source_policy_uuid=eligibility.source_policy_uuid,
                source_policy_version=eligibility.source_policy_version,
                source_attribution_uuid=eligibility.source_attribution_uuid,
                source_digest=eligibility.source_digest,
                replay_digest=eligibility.replay_digest,
                evidence_envelope_uuid=eligibility.evidence_envelope_uuid,
                evidence_envelope_digest=eligibility.evidence_envelope_digest,
                source_engine_version=eligibility.source_engine_version,
                mining_config_digest=eligibility.mining_config_digest,
                outcome_contract=eligibility.outcome_contract,
                source_validation_statistics=eligibility.source_validation_statistics,
                source_validated_at=eligibility.source_validated_at,
                source_validation_thresholds=eligibility.source_validation_thresholds,
                promotion_policy_thresholds=eligibility.promotion_policy_thresholds,
                threshold_monotonicity_result=eligibility.threshold_monotonicity_result,
                source_promotion_created_at=eligibility.source_promotion_created_at,
                source_registry_recorded_at=eligibility.source_registry_recorded_at,
