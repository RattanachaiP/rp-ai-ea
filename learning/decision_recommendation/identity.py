"""Canonical, domain-separated identities for PR185 artifacts."""

import json
from hashlib import sha256
from uuid import UUID, uuid5

RECORD_NAMESPACE = UUID("f1850001-0000-5000-8000-000000000001")
SNAPSHOT_NAMESPACE = UUID("f1850002-0000-5000-8000-000000000002")
REPORT_NAMESPACE = UUID("f1850003-0000-5000-8000-000000000003")
POLICY_NAMESPACE = UUID("f1850004-0000-5000-8000-000000000004")
