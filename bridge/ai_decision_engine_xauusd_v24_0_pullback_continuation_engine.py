...
# - V24_0: TREND NORMAL Momentum Override (TREND_LOCK + strong MACD can pass even with score_gap=1)
# - V24_0: Transition Decay Logic V1 (Soft Lock waits for persistent weakening before TRANSITION_WAIT)
# - V24_0: Trend Exhaustion Detection (avoid late continuation when RSI/MACD/BB/wick show exhaustion)
# - V24_0: Market Structure + Exhaustion Master Gate (HH/HL, LH/LL, BOS/CHOCH, liquidity sweep, distribution/accumulation, late-entry block)
# - V24_0.1: Soft Lock Counter Reset (reset stale persistent weakening counter when context/momentum/bar changes)
# - V24.0: Fresh Market State + Soft Lock Stale Reset (decision.json must follow latest market_state)
# - V24.0: Fresh Market State Read Fix (force fresh file read every loop + MARKET_STATE_READ log)
# - V24.0: Pullback Continuation Engine (healthy pullback + continuation return, avoid expansion chase)
# ============================================================
...
# V24.0 Fresh Market State Read Fix
...
# V24_0 TREND NORMAL Continuation Override
...
# V24_0 Strong Trend Continuation Cooldown Override
...
# V24_0 TREND NORMAL Momentum Override
...
# V24_0 Transition Decay Logic V1
...
# V24_0.1 Soft Lock Counter Reset
...
# V24_0 Market Structure + Exhaustion Master Gate
...
def can_fire_or_strong_override(key, bar_time, decision, data):
    """
    V24_0 cooldown/max-signal gate.
