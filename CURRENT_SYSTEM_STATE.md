...
- `runtime.production_startup` is the canonical operator-facing entrypoint. It resolves
  the sole ready persisted PR184 Decision Intelligence from the unique owner-emitted
  repository-complete snapshot and verifies its digest, policy, engine, and lineage
  without timestamp, filename-order, or latest-record selection,
