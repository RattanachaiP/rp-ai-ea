...
retried only within that same execution cycle and always uses the same frozen
instruction and execution ID; the configured retry count bounds this behavior.
